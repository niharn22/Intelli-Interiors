    ...
    return (
        <>
            ...
            <div className="main">
                ...
                <div className="flex flex-wrap justify-around mx-2 my-14">
                    {/* Card 1 */}
                    <div className="w-full h-60 sm:w-1/2 lg:w-1/4 px-4 mb-4">
                        <div className="h-full flex justify-center items-center flex-wrap bg-purple-100 p-6 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
                            <h2 className="text-2xl font-semibold w-full mb-2 text-gray-800">Real-Time Project Updates</h2>
                    ...
                    <div className="w-full h-60 sm:w-1/2 lg:w-1/4 px-4 mb-4">
                        <div className="h-full flex justify-center items-center flex-wrap bg-purple-100 p-6 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
                            <h2 className="text-2xl font-semibold w-full mb-2 text-gray-800">Integrated Task Management</h2>
                            <p className="text-gray-600">
                                Allowing tracking and updates of varoious task associated with interior design.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-full h-60 sm:w-1/2 lg:w-1/4 px-4 mb-4">
                        <div className="h-full flex justify-center items-center flex-wrap bg-purple-100 p-6 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
                            <h2 className="text-2xl font-semibold w-full mb-2 text-gray-800">Comrehensive budgeting</h2>
                            <p className="text-gray-600">
                                Ensuring financial transparency thourghout the project
                            </p>
                        </div>
                    </div>
